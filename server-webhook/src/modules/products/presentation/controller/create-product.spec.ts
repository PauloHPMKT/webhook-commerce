...
describe('CreateProductController', () => {
  ...
  it('should return 201 if valid data is provided with discount', async () => {
    const { sut, createProductUseCaseStub } = makeSut();
    jest.spyOn(createProductUseCaseStub, 'execute').mockImplementationOnce(async () => {
      const product = {
        id: 'valid_id',
  ...
  it('should return 201 if valid data is provided with category', async () => {
    const { sut, createProductUseCaseStub } = makeSut();
    jest.spyOn(createProductUseCaseStub, 'execute').mockImplementationOnce(async () => {
      const product = {
        id: 'valid_id',
  ...
  it('should return 201 if valid data is provided with all fields', async () => {
    const { sut, createProductUseCaseStub } = makeSut();
    jest.spyOn(createProductUseCaseStub, 'execute').mockImplementationOnce(async () => {
      const product = {
        id: 'valid_id',
